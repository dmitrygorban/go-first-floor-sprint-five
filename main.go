...
func (w Walking) Calories() float64 {
	meanSpeedInMpS := w.meanSpeed() * KmHInMsec
	heightInM := w.Height / CmInM
	return ((CaloriesWeightMultiplier * w.Weight) + ((math.Pow(meanSpeedInMpS, 2) / heightInM) * CaloriesSpeedHeightMultiplier * w.Weight)) * w.Duration.Hours() * MinInHours
}
